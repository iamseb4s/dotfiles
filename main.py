    ...
    try:
        ...
        while True:
            ...
            if state == "WELCOME":
                ...
                # Use all selected IDs (manual + automatic dependencies)
                selected_ids = list(effective_overrides.keys())
                installer = InstallerScreen(modules, selected_ids, effective_overrides)
